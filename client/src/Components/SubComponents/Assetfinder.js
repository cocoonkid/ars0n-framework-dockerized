        ...
        <div className="container mt-5">
            <div className="row">
                <div className="col-12">
                    ...
                    <p><b>RUN: </b><span onClick={notify}> assetfinder --subs-only {props.thisFqdn.fqdn} &gt; assetfinder.{props.thisFqdn.fqdn}.txt; cat assetfinder.{props.thisFqdn.fqdn}.txt | xclip -i -selection clipboard</span></p>
                </div>
            </div>
            <div className="row">
            {

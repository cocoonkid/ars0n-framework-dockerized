        ...
        <div className="container mt-5">
            <div className="row">
                <div className="col-12">
                    ...
                    <p><b>RUN: </b><span onClick={notify}> python sublist3r.py -d {props.thisFqdn.fqdn} -t 50 -o sublist3r.{props.thisFqdn.fqdn}.txt -v; cat sublist3r.{props.thisFqdn.fqdn}.txt | xclip -i -selection clipboard</span></p>
                </div>
            </div>
            <div className="row">
                {

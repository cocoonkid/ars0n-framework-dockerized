        ...
        <div className="container mt-5">
            <div className="row">
                <div className="col-12">
                    ...
                    <p><b>RUN: </b><span onClick={notify}>cat /home/ars0n/tmp/amass.tmp | ./hakrawler -subs -d 3 -u &gt; hakrawler.{props.thisFqdn.fqdn}.txt; cat hakrawler.{props.thisFqdn.fqdn}.txt | xclip -i -selection clipboard</span></p> 
                </div>
            </div>
            <div className="row">
                {
